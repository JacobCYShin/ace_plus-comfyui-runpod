...
RUN uv pip install runpod requests websocket-client boto3 psutil
...
# ✅ rgthree-comfy 설치 (ImageResize+ 아님, 다른 유틸용)
...
RUN if [ "$MODEL_TYPE" = "acepp" ]; then \
      ...
      wget -q -O models/clip/clip_l.safetensors https://huggingface.co/comfyanonymous/flux_text_encoders/resolve/main/clip_l.safetensors && \
      wget -q -O models/clip/t5xxl_fp16.safetensors https://huggingface.co/comfyanonymous/flux_text_encoders/resolve/main/t5xxl_fp16.safetensors && \
